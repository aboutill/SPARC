...
def run(
    ...
    out_dirs = [stacks_nii_dir, chest_mask_dir, cine_nii_dir, heart_mask_dir, cine_dcm_dir]
    for d in out_dirs:
    ...
    (stack_mag_nii_paths, stack_pha_nii_paths, stack_infos, gui_elapsed) = (
        self.pre_processor.run_with_gui(
            input_dir=input_dir,
    ...
    (
        ...
        chest_mask_qc_path,
        gui_elapsed,
    ) = self.chest_segmentator.run_with_gui(
    ...
    if self.heart_segmentator.activate:
        (heart_mask_path, heart_mask_qc_path, gui_elapsed) = self.heart_segmentator.run_with_gui(
    ...
    (reo_cine_nii_path, reo_qc_report_path, gui_elapsed) = self.reorientor.run_with_gui(
        cine_nii_path=cine_nii_path,
